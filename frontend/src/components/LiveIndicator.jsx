...
/**
 * LiveIndicator - Enhanced Web3 Version
 *
 * Shows a pulsing dot with "Live" label and glow effects
 * Used to indicate real-time WebSocket updates
 */
function LiveIndicator({ variant = 'default' }) {
  const variants = {
    default: {
      color: '#22c55e',
  ...
  return (
    <span
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = `0 8px 24px ${style.glowColor}`;
      }}
      onMouseLeave={(e) => {
      ...
      >
        ...
        <span
          style={{
            ...
            borderRadius: '50%',
            background: style.color,
            boxShadow: `0 0 12px ${style.glowColor}, 0 0 24px ${style.glowColor}`,
